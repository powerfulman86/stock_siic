odoo.define('stock_transfer_report.stock_transfer_report_backend', function (require) {
    'use strict';
    ...
    var report_backend = AbstractAction.extend({
        ...
        events: {
            'click .o_stock_transfer_reports_print': 'print',
            'click .o_stock_transfer_reports_export': 'export',
        },
